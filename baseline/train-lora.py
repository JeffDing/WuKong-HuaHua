...
def main(opts):
    ...
    LatentDiffusionWithLoss = instantiate_from_config(opts.model_config_path)

    load_pretrained_model(opts.pretrained_model, LatentDiffusionWithLoss)
    ...
    if not opts.decay_steps:
        ...
        opts.decay_steps = opts.train_epochs * dataset_size
    ...
    model.train(opts.train_epochs, dataset, callbacks=callback, dataset_sink_mode=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--fine_data_path', default="/home/ma-user/work/wukong/my_data/", type=str, help='data path')
    parser.add_argument('--output_path', default="/home/ma-user/work/wukong/output/", type=str, help='use audio out')
    parser.add_argument('--train_config', default="configs/train_config.json", type=str, help='train config path')
    parser.add_argument('--start_learning_rate', default=1e-4, type=float, help='start learning rate for Adam')
    parser.add_argument('--end_learning_rate', default=1e-6, type=float, help='end learning rate for Adam')
    parser.add_argument('--model_config_path', default="configs/v1-train-chinese-lora.yaml", type=str, help='model config path')
    
    parser.add_argument('--pretrained_model', default="/home/ma-user/work/wukong/wukong-huahua-ms.ckpt", type=str, help='pretrained model file name')
    ...
    parser.add_argument("--train_epochs", default=1000, type=int, help="epochs")
    parser.add_argument("--init_loss_scale", default=65536, type=float, help="loss scale")
    parser.add_argument("--loss_scale_factor", default=2, type=float, help="loss scale factor")
    parser.add_argument("--scale_window", default=300, type=float, help="scale window")
    parser.add_argument("--save_checkpoint_steps", default=100, type=int, help="save checkpoint steps")
