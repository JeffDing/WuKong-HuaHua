...
if __name__ == "__main__":
    ...
    parser.add_argument('--fine_data_path', default="/home/ma-user/work/wukong/xy_data/", type=str, help='data path')
    parser.add_argument('--output_path', default="/home/ma-user/work/wukong/output_lora/", type=str, help='use audio out')
