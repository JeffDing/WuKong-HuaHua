...
def main():
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="configs/v1-inference-chinese-lora.yaml",
        help="path to config which constructs model",
    )
    parser.add_argument(
        "--ckpt_path",
        type=str,
        default="/home/ma-user/work/wukong/wukong-huahua-ms.ckpt",
    ...
    parser.add_argument("--lora_ckpt_filepath", type=str, default="/home/ma-user/work/wukong/output/lora.ckpt", help="path to checkpoint of model with lora")
